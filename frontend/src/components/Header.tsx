...
export default function Header() {
  return (
    <header className=" relative bg-white flex items-center justify-center h-80 sm:h-160 overflow-hidden">
      ...
      <div className=" sm:block hidden w-100  absolute  lg:mr-110 lg:w-140  xl:mr-170 flex-col gap-5 ">
      <h2 className="font-bold text-3xl md:text-4xl lg:text-5xl mb-3">DISCOVER DOGS AND THEIR PERSONALITIES</h2>
      <h4 className="text-sm md:text-md w-90 lg:w-full">Browse different dog breeds and explore their characteristics, temperament, and needs. Compare profiles, view photos, and find the dog that best suits your lifestyle — whether you're looking for an active training companion or a calm family dog.</h4>
      </div>
    </header>
  );
}