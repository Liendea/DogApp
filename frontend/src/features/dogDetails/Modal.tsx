...
export default function Modal({ dog, onClose }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm p-4">
      <section className="relative w-full max-w-4xl max-h-[90dvh] overflow-hidden rounded-2xl bg-white shadow-2xl flex flex-col md:flex-row">
        {/* FavBtn */}
          ...
          <div className="mt-6 md:mt-8 grid md:grid-cols-2 gap-2 md:gap-6">
            ...
            <div>
              <div className="flex items-center gap-2">
                <svg
                  className="h-5 w-5shrink-0 text-primary"
                  viewBox="0 0 33 33"
                  fill="none"
