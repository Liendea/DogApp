...
export default function Header() {
  return (
    <header className="relative bg-white flex items-end justify-center md:justify-start text-center md:text-left h-90 md:h-120 lg:h-160 overflow-hidden">
      ...
      <div className="w-full max-w-md md:max-w-2xl lg:max-w-3xl absolute left-4 lg:left-auto pb-10 lg:mr-110 lg:w-140 xl:mr-170 flex flex-col items-start justify-start text-left px-2">
        ...
        <h4 className="text-sm w-full max-w-xs text-left sm:hidden mr-4">
        ...
        <h4 className="text-sm md:text-md w-full max-w-xs md:max-w-xl lg:max-w-none md:pl-4 lg:w-full mr-4 text-left hidden sm:block">
